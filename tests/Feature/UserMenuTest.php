...
class UserMenuTest extends TestCase
{
    ...
    {
        $this->actingAs($this->admin)->post('admin/checklist-groups', [
            'name' => 'First group'
        ]);
    ...
    public function test_checklist_new_upd_icons_show_correctly()
    {
        ...
        sleep(2);
        $this->actingAs($this->admin)->put('admin/checklist-groups/' . $checklist_group->id, [
            'name' => 'Updated name'
        ]);
        $this->actingAs($this->user);
        $menu = (new MenuService())->get_menu();
        ...
        $this->actingAs($this->admin)->put('admin/checklist-groups/' . $checklist_group->id . '/checklists/' . $checklist->id, [
            'name' => 'Updated name'
        ]);
        $this->actingAs($this->user);
        $menu = (new MenuService())->get_menu();
